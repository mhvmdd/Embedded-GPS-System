...
typedef struct{
	...
	volatile u32 DATA;	//0x000
	volatile u32 DIR;		//0x400
	volatile u32 AFSEL;	//0x420
	volatile u32 PUR;		//0x510
	volatile u32 PDR;		//0x514
	volatile u32 DEN;		//0x51C
	volatile u32 LOCK;	//0x520
	volatile u32 CR;		//0x524
	volatile u32 AMSEL;	//0x528
	volatile u32 PCTL;	//0x52C
